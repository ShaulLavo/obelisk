 ...
 *
 * Canonical location for file-loading error types shared between the fs
 * and split-editor modules. This file lives in fs/ (not split-editor/)
 * because it is fundamentally about file-system operations. The split-editor
 * module re-exports from here via `split-editor/fileLoadingErrors.ts`.
 *
