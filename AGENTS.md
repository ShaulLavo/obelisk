...
- **Debugging**: Always use `console.log` for debugging, **never** use `@repo/logger`. The logger is for production logging only. Always wrap data in `JSON.stringify(data, null, 2)` specifically.
