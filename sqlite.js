  ...
  ;(function (Module2) {
    const sIMS =
      ...
      Object.assign(Object.create(null), {
        debugModule: function () {
          console.warn(
            'globalThis.sqlite3InitModuleState is missing',
            arguments
          )
        }
      })
    ...
    Module2['instantiateWasm'] = function callee(imports, onSuccess) {
      ...
      const uri = Module2.locateFile(
        sims.wasmFilename,
        typeof scriptDirectory === 'undefined' ? '' : scriptDirectory
      )
...
`
  ...
  function assignWasmExports(wasmExports2) {
    assert(
      typeof wasmExports2['strerror'] != 'undefined',
      'missing Wasm export: strerror'
    )
    assert(
      typeof wasmExports2['malloc'] != 'undefined',
      'missing Wasm export: malloc'
    )
    assert(
      typeof wasmExports2['free'] != 'undefined',
      'missing Wasm export: free'
    )
    assert(
      typeof wasmExports2['realloc'] != 'undefined',
      'missing Wasm export: realloc'
    )
    assert(
      typeof wasmExports2['fflush'] != 'undefined',
      'missing Wasm export: fflush'
    )
    assert(
      typeof wasmExports2['emscripten_stack_get_end'] != 'undefined',
      'missing Wasm export: emscripten_stack_get_end'
    )
    assert(
      typeof wasmExports2['emscripten_stack_get_base'] != 'undefined',
      'missing Wasm export: emscripten_stack_get_base'
    )
    assert(
      typeof wasmExports2['emscripten_builtin_memalign'] != 'undefined',
      'missing Wasm export: emscripten_builtin_memalign'
    )
    assert(
      typeof wasmExports2['emscripten_stack_init'] != 'undefined',
      'missing Wasm export: emscripten_stack_init'
    )
    assert(
      typeof wasmExports2['emscripten_stack_get_free'] != 'undefined',
      'missing Wasm export: emscripten_stack_get_free'
    )
    assert(
      typeof wasmExports2['_emscripten_stack_restore'] != 'undefined',
      'missing Wasm export: _emscripten_stack_restore'
    )
    assert(
      typeof wasmExports2['_emscripten_stack_alloc'] != 'undefined',
      'missing Wasm export: _emscripten_stack_alloc'
    )
    assert(
      typeof wasmExports2['emscripten_stack_get_current'] != 'undefined',
      'missing Wasm export: emscripten_stack_get_current'
    )
    assert(
      typeof wasmExports2['__set_stack_limits'] != 'undefined',
      'missing Wasm export: __set_stack_limits'
    )
    assert(
      typeof wasmExports2['__indirect_function_table'] != 'undefined',
  ...
  Module.runSQLite3PostLoadInit = async function (
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(
      ...
      ;['exports', 'memory', 'functionTable', 'wasmfsOpfsDir'].forEach(k2 => {
      ...
      const isTypedArray = v2 => {
        return v2 && v2.constructor && isInt32(v2.constructor.BYTES_PER_ELEMENT)
          ? v2
          : false
      }
      const isBindableTypedArray = v2 =>
        ...
        (v2 instanceof Uint8Array ||
          v2 instanceof Int8Array ||
          v2 instanceof ArrayBuffer)
      ...
      Object.assign(wasm, {
        ...
        pointerSize:
          typeof config.exports.sqlite3_libversion() === 'number' ? 4 : 8,
      ...
      {
        const {
          allocExportName: keyAlloc,
          deallocExportName: keyDealloc,
          reallocExportName: keyRealloc
        } = config
      ...
      capi.sqlite3_column_js = function (
        ...
        return v2 === 0
          ? undefined
          : capi.sqlite3_value_to_js(v2, throwIfCannotConvert)
      }
      if (true) {
        ...
        capi.sqlite3_preupdate_new_js = (pDb2, iCol) =>
          __newOldValue(pDb2, iCol, 'sqlite3_preupdate_new')
        capi.sqlite3_preupdate_old_js = (pDb2, iCol) =>
          __newOldValue(pDb2, iCol, 'sqlite3_preupdate_old')
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      sqlite3.version = {
        libVersion: '3.52.0',
        libVersionNumber: 3052000,
        sourceId:
          '2025-12-11 11:05:26 117f4093f08e0abbde2041f70898220e237e250664f6ede6d4eb2a8a4405alt1',
        downloadVersion: 3520000,
        scm: {
          'sha3-256':
            '117f4093f08e0abbde2041f70898220e237e250664f6ede6d4eb2a8a4405alt1',
          branch: 'trunk',
          tags: '',
          datetime: '2025-12-11T11:05:26.817Z'
        }
      }
    })
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      ...
      const __BigInt = target.bigIntEnabled
        ? v2 => BigInt(v2 || 0)
        : v2 => toss('BigInt support is disabled in this build.')
      ...
      }
      {
        ...
        ;(function f(name, val) {
          ...
          'addn',
          __ptrIR === 4 ? __ptrAdd : (...args) => Number(__ptrAdd(...args))
        )
      }
      if (!target.exports) {
      ...
      target.peekPtr = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, __ptrIR)
      target.pokePtr = (ptr, value = 0) => target.poke(ptr, value, __ptrIR)
      target.peek8 = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'i8')
      target.poke8 = (ptr, value) => target.poke(ptr, value, 'i8')
      target.peek16 = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'i16')
      target.poke16 = (ptr, value) => target.poke(ptr, value, 'i16')
      target.peek32 = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'i32')
      target.poke32 = (ptr, value) => target.poke(ptr, value, 'i32')
      target.peek64 = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'i64')
      target.poke64 = (ptr, value) => target.poke(ptr, value, 'i64')
      target.peek32f = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'f32')
      target.poke32f = (ptr, value) => target.poke(ptr, value, 'f32')
      target.peek64f = (...ptr) =>
        target.peek(ptr.length === 1 ? ptr[0] : ptr, 'f64')
      ...
      target.isPtr32 = ptr =>
        typeof ptr === 'number' && ptr >= 0 && ptr === (ptr | 0)
      target.isPtr64 = ptr =>
        typeof ptr === 'bigint' ? ptr >= 0 : target.isPtr32(ptr)
      ...
      const typedArrayPart = (aTypedArray, begin, end) => {
        if (__ptrSize === 8) {
          if (typeof begin === 'bigint') begin = Number(begin)
      ...
      const __allocCStr = function (
        ...
        if (typeof jstr !== 'string') return null
      ...
      target.scopedAllocPop = function (state) {
        ...
        if (arguments.length === 0) state = cache.scopedAlloc[n]
      ...
      target.xCall = function (fname, ...args) {
        ...
        return arguments.length === 2 && Array.isArray(arguments[1])
      ...
      cache.xWrap.convertResult = (t, v2) =>
        t === null ? v2 : t ? __xResultAdapterCheck(t)(v2) : undefined
      cache.xWrap.convertResultNoCheck = (t, v2) =>
        t === null ? v2 : t ? xResult.get(t)(v2) : undefined
      ...
      const __xAdapter = function (
        ...
        if (typeof typeName === 'string') {
          if (argc === 1) return xcvPart.get(typeName)
          else if (argc === 2) {
            if (!adapter) {
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      ;['alloc', 'dealloc'].forEach(function (k2) {
        config[k2] instanceof Function ||
          toss("Config option '" + k2 + "' must be a function.")
      })
      const SBF = StructBinderFactory
      const { heap, alloc, dealloc } = config,
        realloc =
          config.realloc ||
          function () {
        ...
        BigInt2 = globalThis['BigInt'],
        BigInt64Array2 = globalThis['BigInt64Array'],
        bigIntEnabled = config.bigIntEnabled ?? !!BigInt64Array2
      let ptr
      const ptrSize =
        config.pointerSize ||
        config.ptrSize ||
        (typeof (ptr = alloc(1)) === 'bigint' ? 8 : 4)
      const ptrIR =
        config.pointerIR || config.ptrIR || (ptrSize === 4 ? 'i32' : 'i64')
      if (ptr) {
        dealloc(ptr)
        ptr = undefined
      }
      ...
      const affirmBigIntArray = BigInt64Array2
        ? () => true
      ...
      const __isPtr32 = ptr2 =>
        typeof ptr2 === 'number' && ptr2 === (ptr2 | 0) && ptr2 >= 0
      const __isPtr64 = ptr2 =>
        (typeof ptr2 === 'bigint' && ptr2 >= 0) || __isPtr32(ptr2)
      ...
      const __adaptor = function (who, which, key, proxy2) {
        ...
        if (arguments.length === 3) return a[key]
        if (proxy2) return (a[key] = proxy2)
        return delete a[key]
      }
      ...
      const __memberIsString = function (
        ...
        return m && m.signature.length === 1 && m.signature[0] === 's'
          ? m
          : false
      }
      ...
      const memberGetterProxy = function (si) {
        return (
          si.get ||
          (si.adaptGet ? StructBinder.adaptGet(si.adaptGet) : undefined)
        )
      }
      const memberSetterProxy = function (si) {
        return (
          si.set ||
          (si.adaptSet ? StructBinder.adaptSet(si.adaptSet) : undefined)
        )
      }
      const makeMemberStructWrapper = function callee(ctor, name, si) {
        ...
        const prop = Object.assign(Object.create(null), {
          ...
          get: function () {
            ...
            if (dbg2.getter) log('debug.getter: result =', s)
            return s
          }
        })
      ...
      const makeMemberWrapper = function f(ctor, name, si) {
        ...
        prop.get = function () {
          ...
          if (dbg2.getter) log('debug.getter:', xPropName, 'result =', rc)
          return rc
        }
        if (si.readOnly) {
          ...
          prop.set = function (v2) {
            ...
            if (v2 === null || v2 === undefined) v2 = __NullPtr
      ...
      const StructBinderImpl = function StructBinderImpl(
        ...
        const self = this
        const ads = x => {
          return typeof x === 'string' && looksLikeASig(x)
            ? { signature: x }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      delete globalThis.Jaccwabyt
      {
        ...
        wasm.xWrap.argAdapter('string:flexible', v2 =>
          __xString(util.flexibleString(v2))
        )
        ...
        if (wasm.exports.sqlite3_declare_vtab) {
          wasm.xWrap.argAdapter('sqlite3_index_info*', v2 =>
            __xArgPtr(
              v2 instanceof (capi.sqlite3_index_info || nilType)
                ? v2.pointer
                : v2
            )
          )('sqlite3_module*', v2 =>
        ...
        util.sqlite3__wasm_db_error = function (pDb2, resultCode, message) {
          ...
          return (
            capi.sqlite3_set_errmsg(pDb2, resultCode, message) || resultCode
          )
        }
      }
      {
      ...
      }
      {
        ...
        capi.sqlite3_prepare_v2 = function f(
          ...
          return f.length === arguments.length
            ? capi.sqlite3_prepare_v3(pDb2, sql, sqlLen, 0, ppStmt, pzTail)
            : __dbArgcMismatch(pDb2, 'sqlite3_prepare_v2', f.length)
        }
      }
      {
      ...
      }
      {
        ...
        capi.sqlite3_auto_extension = function (fPtr) {
          ...
          if (fPtr !== arguments[0]) {
            if (rc === 0) __autoExtFptr.add(fPtr)
            else wasm.uninstallFunction(fPtr)
          }
          return rc
        }
        capi.sqlite3_cancel_auto_extension = function (fPtr) {
          if (!fPtr || arguments.length !== 1 || !wasm.isPtr(fPtr)) return 0
      ...
      StructBinder.StructType.prototype.installMethod = function callee(
        ...
        return arguments.length < 3 && name && typeof name === 'object'
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const dbCtorHelper = function ctor(...args) {
        ...
        if ((pDb2 = opt['sqlite3*'])) {
          ...
          if (
            (typeof fn !== 'string' && !wasm.isPtr(fn)) ||
            typeof flagsStr !== 'string' ||
            (vfsName && typeof vfsName !== 'string' && !wasm.isPtr(vfsName))
          ) {
          ...
          if (oflags === 0) oflags |= capi.SQLITE_OPEN_READONLY
      ...
      const affirmSupportedBindType = function (v2) {
        return (
          isSupportedBindType(v2) ||
          toss3('Unsupported bind() argument type:', typeof v2)
        )
      }
      ...
      Stmt.prototype = {
        ...
        bind: function () {
          ...
          if (arg === null) {
            ...
            arg.forEach((v2, i) =>
              bindOne(this, i + 1, affirmSupportedBindType(v2), v2)
            )
            return this
          ...
          if (typeof arg === 'object' && !util.isBindableTypedArray(arg)) {
            ...
            Object.keys(arg).forEach(k2 =>
              bindOne(this, k2, affirmSupportedBindType(arg[k2]), arg[k2])
            )
            return this
          } else {
      ...
      sqlite3.initWorker1API = function () {
        ...
        const wState = {
          ...
          getDb: function (id, require2 = true) {
            return (
              this.dbs[id] ||
              (require2 ? toss('Unknown (or closed) DB ID:', id) : undefined)
            )
          }
        }
          ...
          exec: function (ev) {
            ...
            try {
              const changeCount = rc.countChanges
                ? db.changes(true, rc.countChanges === 64)
                : undefined
              db.exec(rc)
              if (changeCount !== undefined) {
                rc.changeCount =
                  db.changes(true, rc.countChanges === 64) - changeCount
              }
              const lastInsertRowId = rc.lastInsertRowId
                ? sqlite32.capi.sqlite3_last_insert_rowid(db)
                : undefined
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const __xWrapFactory = function (methodName, StructType) {
        return function (ptr, removeMapping = false) {
          if (arguments.length === 0) ptr = new StructType()
      ...
      vtab.setupModule = function (opt) {
        ...
        try {
          ...
          for (const e of Object.entries({
            ...
            const k2 = e[0],
              v2 = e[1]
            if (methods[k2] === true) methods[k2] = methods[v2]
            else if (methods[v2] === true) methods[v2] = methods[k2]
          }
          ...
          if (mod.$iVersion === 0) {
            let v2
            if (typeof opt.iVersion === 'number') v2 = opt.iVersion
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      const { util, wasm } = sqlite3,
        toss3 = util.toss3,
        hop = (o, k2) => Object.prototype.hasOwnProperty.call(o, k2)
      ...
      const kvvfsKeyPrefix = v2 =>
        kvvfsIsPersistentName(v2) ? 'kvvfs-' + v2 + '-' : ''
      ...
      const newStorageObj = (name, storage = undefined) =>
        Object.assign(Object.create(null), {
          jzClass: name,
          refc: 1,
          deleteAtRefc0: false,
          ...
          xOpen: function (pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
            ...
            try {
              ...
              if (s) {
                ...
                util.assert(
                  !f.$isJournal,
                  'Opening a journal before its db? ' + jzClass
                )
      ...
      try {
        ...
        for (const e of Object.entries(methodOverrides.vfs)) {
          const k2 = e[0],
            f = e[1],
            km = pVfs.memberKey(k2),
            member =
              pVfs.structInfo.members[k2] ||
              util.toss('Missing pVfs.structInfo[', k2, ']')
        ...
        for (const e of Object.entries(methodOverrides.ioDb)) {
          const k2 = e[0],
            f = e[1],
            km = pIoDb.memberKey(k2)
          originalMethods.ioDb[k2] =
        ...
        for (const e of Object.entries(methodOverrides.ioJrnl)) {
          const k2 = e[0],
            f = e[1],
            km = pIoJrnl.memberKey(k2)
          originalMethods.ioJrnl[k2] =
            wasm.functionEntry(pIoJrnl[km]) ||
            util.toss('Missing native pIoJrnl[', km, ']')
          if (f === true) {
            pIoJrnl[km] =
              pIoDb[km] || util.toss('Missing copied pIoDb[', km, ']')
          } else {
      ...
      const sqlite3_js_kvvfs_export = function callee(...args) {
        ...
        Object.keys(pages)
          .map(v2 => +v2)
          .sort()
          .forEach(v2 => rc.pages.push(pages[v2]))
        return rc
      }
        ...
        try {
          ...
          if (exp.pages[0] instanceof Uint8Array) {
            exp.pages.forEach((u, ndx) => {
              ...
              util.assert(
                wasm.peek8(wasm.ptr.add(zEnc, rc)) === 0,
      ...
      if (sqlite3.oo1?.DB) {
        ...
        sqlite3.oo1.JsStorageDb.defaultStorageName = cache.storagePool.session
          ? 'session'
      ...
      if (sqlite3.__isUnderTest && sqlite3.vtab) {
        ...
        Object.assign(Object.create(ProtoCursor), {
          ...
          names: Object.keys(cache.storagePool).filter(
            v2 => !cache.rxJournalSuffix.test(v2)
          )
        })
...
Total of`,
          ...
          const opRun = (op, ...args) => {
            ...
            while (
              Atomics.wait(state.sabOPView, state.opIds.rc, -1) !== 'not-equal'
            ) {}
            ...
            const doDir = async function callee(dirHandle, depth) {
              for await (const handle of dirHandle.values()) {
                if (opt.callback(handle, dirHandle, depth) === false)
                  ...
                  if ((await callee(handle, depth + 1)) === false) break
                }
              }
            }
          ...
          const sanityCheck = function () {
            ...
            try {
              ...
              if (rc[0] !== 'This is ä string.') toss('String d13n error.')
              ...
              log('xRead() got:', jRead)
              if (jRead !== 'sanity') toss('Unexpected xRead() value.')
        ...
        try {
          ...
          if (sqlite32?.scriptInfo?.sqlite3Dir) {
            installOpfsVfs.defaultProxyUri =
              sqlite32.scriptInfo.sqlite3Dir + proxyJs
          }
...
globalThis.sqlite3Worker1Promiser = function callee(
  ...
  if (typeof config.worker === 'function') config.worker = config.worker()
  let dbId
  let promiserFunc
...
globalThis.sqlite3Worker1Promiser.v2 = function callee2(
  config = callee2.defaultConfig
) {
  let oldFunc
...
class ResultSetImpl {
  ...
  toJSON() {
    return {
      ...
      lastInsertRowid:
        this.lastInsertRowid !== undefined ? '' + this.lastInsertRowid : null
    }
  }
}
...
function expandConfig(config, preferHttp) {
  ...
  for (const { key, value } of uri.query?.pairs ?? []) {
    ...
    if (
      ...
      throw new LibsqlError(
        `Unknown value for the "${key}" query argument: ${JSON.stringify(
          value
        )}. Supported values are: [${queryParamDef.values
          .map(x => '"' + x + '"')
          .join(', ')}]`,
        'URL_INVALID'
      )
  ...
  if (intMode !== 'number' && intMode !== 'bigint' && intMode !== 'string') {
    throw new TypeError(
      `Invalid value for intMode, expected "number", "bigint" or "string", got ${JSON.stringify(
        intMode
      )}`
    )
  }
...
class Sqlite3Client {
  ...
  async execute(stmtOrSql, args) {
    ...
    __classPrivateFieldGet(
      this,
      _Sqlite3Client_instances,
      'm',
      _Sqlite3Client_checkNotClosed
    ).call(this)
    return executeStmt(
      __classPrivateFieldGet(this, _Sqlite3Client_sqlite3, 'f'),
      __classPrivateFieldGet(
        this,
        _Sqlite3Client_instances,
        'm',
        _Sqlite3Client_getDb
      ).call(this),
      stmt,
      __classPrivateFieldGet(this, _Sqlite3Client_intMode, 'f')
    )
  }
  ...
  async batch(stmts, mode = 'deferred') {
    ...
    const db = __classPrivateFieldGet(
      this,
      _Sqlite3Client_instances,
      'm',
      _Sqlite3Client_getDb
...
;(_Sqlite3Client_sqlite3 = new WeakMap()),
  (_Sqlite3Client_path = new WeakMap()),
  (_Sqlite3Client_db = new WeakMap()),
  (_Sqlite3Client_intMode = new WeakMap()),
  (_Sqlite3Client_poolUtil = new WeakMap()),
  (_Sqlite3Client_instances = new WeakSet()),
  (_Sqlite3Client_checkNotClosed = function _Sqlite3Client_checkNotClosed2() {
    if (this.closed) {
  ...
  (_Sqlite3Client_getDb = function _Sqlite3Client_getDb2() {
    if (__classPrivateFieldGet(this, _Sqlite3Client_db, 'f') === null) {
      __classPrivateFieldSet(
        ...
        createDb(
          __classPrivateFieldGet(this, _Sqlite3Client_sqlite3, 'f'),
          __classPrivateFieldGet(this, _Sqlite3Client_path, 'f'),
          __classPrivateFieldGet(this, _Sqlite3Client_poolUtil, 'f')
        ),
        'f'
      )
    }
...
class Sqlite3Transaction {
  ...
  async execute(stmt) {
    __classPrivateFieldGet(
      this,
      _Sqlite3Transaction_instances,
      'm',
      _Sqlite3Transaction_checkNotClosed
    ).call(this)
    return executeStmt(
      __classPrivateFieldGet(this, _Sqlite3Transaction_sqlite3, 'f'),
      __classPrivateFieldGet(this, _Sqlite3Transaction_database, 'f'),
      stmt,
      __classPrivateFieldGet(this, _Sqlite3Transaction_intMode, 'f')
    )
  }
  async batch(stmts) {
  ...
  async rollback() {
    if (
      !__classPrivateFieldGet(this, _Sqlite3Transaction_database, 'f').isOpen()
    ) {
      return
    }
    __classPrivateFieldGet(
...
;(_Sqlite3Transaction_sqlite3 = new WeakMap()),
  (_Sqlite3Transaction_database = new WeakMap()),
  (_Sqlite3Transaction_intMode = new WeakMap()),
  (_Sqlite3Transaction_instances = new WeakSet()),
  (_Sqlite3Transaction_checkNotClosed =
    function _Sqlite3Transaction_checkNotClosed2() {
      if (this.closed) {
