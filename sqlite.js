...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3.mjs
async function sqlite3InitModule(moduleArg = {}) {
  ...
  (function(Module2) {
    ...
    Module2["instantiateWasm"] = function callee(imports, onSuccess) {
      const sims = this;
      const uri = Module2.locateFile(sims.wasmFilename, typeof scriptDirectory === "undefined" ? "" : scriptDirectory);
...
`;
  ...
  function assignWasmExports(wasmExports2) {
    ...
    assert(typeof wasmExports2["__set_stack_limits"] != "undefined", "missing Wasm export: __set_stack_limits");
  ...
  Module.runSQLite3PostLoadInit = async function(sqlite3InitScriptInfo, EmscriptenModule, sqlite3IsUnderTest) {
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(apiConfig = globalThis.sqlite3ApiConfig || sqlite3ApiBootstrap.defaultConfig) {
      ...
      const isInt32 = (n) => typeof n === "number" && n === (n | 0) && n <= 2147483647 && n >= -2147483648;
      ...
      const flexibleString = function(v2) {
        if (isSQLableTypedArray(v2)) {
          return wasm.typedArrayToString(v2 instanceof ArrayBuffer ? new Uint8Array(v2) : v2, 0, v2.length);
        } else if (Array.isArray(v2))
          return v2.join("");
        else if (wasm.isPtr(v2))
          v2 = wasm.cstrToJs(v2);
        return v2;
      };
      ...
      Object.assign(wasm, {
        ...
        pointerSize: typeof config.exports.sqlite3_libversion() === "number" ? 4 : 8,
      ...
      {
        const { allocExportName: keyAlloc, deallocExportName: keyDealloc, reallocExportName: keyRealloc } = config;
      ...
      wasm.compileOptionUsed = function f(optName) {
        ...
        return typeof optName === "string" ? !!capi.sqlite3_compileoption_used(optName) : false;
      };
      wasm.pstack = Object.assign(Object.create(null), {
        restore: wasm.exports.sqlite3__wasm_pstack_restore,
        alloc: function(n) {
          if (typeof n === "string" && !(n = wasm.sizeofIR(n))) {
        ...
        allocChunks: function(n, sz) {
          if (typeof sz === "string" && !(sz = wasm.sizeofIR(sz))) {
        ...
        allocPtr: (n = 1, safePtrSize = true) => {
          return n === 1 ? wasm.pstack.alloc(safePtrSize ? 8 : wasm.ptr.size) : wasm.pstack.allocChunks(n, safePtrSize ? 8 : wasm.ptr.size);
        },
        call: function(f) {
      ...
      capi.sqlite3_randomness = (...args) => {
        if (args.length === 1 && util.isTypedArray(args[0]) && args[0].BYTES_PER_ELEMENT === 1) {
          const ta = args[0];
          if (ta.byteLength === 0) {
      ...
      capi.sqlite3_wasmfs_opfs_dir = function() {
        ...
        try {
          if (pdir && wasm.xCallWrapped("sqlite3__wasm_init_wasmfs", "i32", ["string"], pdir) === 0) {
      ...
      capi.sqlite3_js_db_export = function(pDb2, schema = 0) {
        ...
        if (!wasm.bigIntEnabled)
          toss3("BigInt support is not enabled.");
      ...
      capi.sqlite3_column_js = function(pStmt, iCol, throwIfCannotConvert = true) {
        ...
        return v2 === 0 ? undefined : capi.sqlite3_value_to_js(v2, throwIfCannotConvert);
      };
      if (true) {
      ...
      if (typeof sqlite3IsUnderTest !== "undefined") {
      ...
      return sqlite3.asyncPostInit().then((s) => {
        if (typeof sqlite3InitScriptInfo !== "undefined") {
          sqlite3InitScriptInfo.debugModule("sqlite3.asyncPostInit() complete", s);
        }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      sqlite3.version = { libVersion: "3.52.0", libVersionNumber: 3052000, sourceId: "2025-12-11 11:05:26 117f4093f08e0abbde2041f70898220e237e250664f6ede6d4eb2a8a4405alt1", downloadVersion: 3520000, scm: { "sha3-256": "117f4093f08e0abbde2041f70898220e237e250664f6ede6d4eb2a8a4405alt1", branch: "trunk", tags: "", datetime: "2025-12-11T11:05:26.817Z" } };
    });
    globalThis.WhWasmUtilInstaller = function WhWasmUtilInstaller(target) {
      if (target.bigIntEnabled === undefined) {
      ...
      if (!target.pointerSize && !target.pointerIR && target.alloc && target.dealloc) {
        ...
        target.pointerSize = typeof ptr === "bigint" ? 8 : 4;
        target.dealloc(ptr);
      }
      if (target.pointerSize && !target.pointerIR) {
        target.pointerIR = target.pointerSize === 4 ? "i32" : "i64";
      }
      const __ptrIR = target.pointerIR ??= "i32";
      const __ptrSize = target.pointerSize ??= __ptrIR === "i32" ? 4 : __ptrIR === "i64" ? 8 : 0;
      delete target.pointerSize;
      delete target.pointerIR;
      if (__ptrIR !== "i32" && __ptrIR !== "i64") {
        toss("Invalid pointerIR:", __ptrIR);
      } else if (__ptrSize !== 8 && __ptrSize !== 4) {
      ...
      const __asPtrType = __ptrSize === 4 ? __Number : __BigInt;
      ...
      };
      {
        ...
        (function f(name, val) {
          ...
          return f;
        })("null", __NullPtr)("size", __ptrSize)("ir", __ptrIR)("coerce", __asPtrType)("add", __ptrAdd)("addn", __ptrIR === 4 ? __ptrAdd : (...args) => Number(__ptrAdd(...args)));
      }
      if (!target.exports) {
      ...
      target.peekPtr = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, __ptrIR);
      target.pokePtr = (ptr, value = 0) => target.poke(ptr, value, __ptrIR);
      target.peek8 = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "i8");
      target.poke8 = (ptr, value) => target.poke(ptr, value, "i8");
      target.peek16 = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "i16");
      target.poke16 = (ptr, value) => target.poke(ptr, value, "i16");
      target.peek32 = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "i32");
      target.poke32 = (ptr, value) => target.poke(ptr, value, "i32");
      target.peek64 = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "i64");
      target.poke64 = (ptr, value) => target.poke(ptr, value, "i64");
      target.peek32f = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "f32");
      target.poke32f = (ptr, value) => target.poke(ptr, value, "f32");
      target.peek64f = (...ptr) => target.peek(ptr.length === 1 ? ptr[0] : ptr, "f64");
      target.poke64f = (ptr, value) => target.poke(ptr, value, "f64");
      target.getMemValue = target.peek;
      target.getPtrValue = target.peekPtr;
      target.setMemValue = target.poke;
      target.setPtrValue = target.pokePtr;
      target.isPtr32 = (ptr) => typeof ptr === "number" && ptr >= 0 && ptr === (ptr | 0);
      target.isPtr64 = (ptr) => typeof ptr === "bigint" ? ptr >= 0 : target.isPtr32(ptr);
      target.isPtr = __ptrSize === 4 ? target.isPtr32 : target.isPtr64;
      ...
      const __SAB = typeof SharedArrayBuffer === "undefined" ? function() {} : SharedArrayBuffer;
      ...
      target.cstrToJs = function(ptr) {
        ...
        return n ? typedArrayToString(heapWrappers().HEAP8U, Number(ptr), Number(ptr) + n) : n === null ? n : "";
      };
      ...
      target.jstrToUintArray = (str, addNul = false) => {
        return cache.utf8Encoder.encode(addNul ? str + "\x00" : str);
      };
      ...
      target.xCall = function(fname, ...args) {
        ...
        return arguments.length === 2 && Array.isArray(arguments[1]) ? f.apply(null, arguments[1]) : f.apply(null, args);
      };
      ...
      xResult.set("*", __xArgPtr).set("pointer", __xArgPtr).set("number", (v2) => Number(v2)).set("void", (v2) => {
        return;
      }).set(undefined, xResult.get("void")).set("null", (v2) => v2).set(null, xResult.get("null"));
      for (const t of [
        "i8",
        "i16",
        "i32",
      ...
      const __xArgString = (v2) => {
        return typeof v2 === "string" ? target.scopedAllocCString(v2) : __asPtrType(v2);
      };
      ...
      xArg.FuncPtrAdapter = class FuncPtrAdapter extends AbstractArgAdapter {
        ...
        convertArg(v2, argv, argIndex) {
          ...
          if (0) {}
          if (pair && pair.length === 2 && pair[0] === v2) {
            return pair[1];
          }
          if (v2 instanceof Function) {
            ...
            if (FuncPtrAdapter.debugFuncInstall) {
              FuncPtrAdapter.debugOut("FuncPtrAdapter installed", this, this.contextKey(argv, argIndex), "@" + fp, v2);
            }
            if (pair) {
              if (pair[1]) {
                if (FuncPtrAdapter.debugFuncInstall) {
                  FuncPtrAdapter.debugOut("FuncPtrAdapter uninstalling", this, this.contextKey(argv, argIndex), "@" + pair[1], v2);
                }
                try {
            ...
            return fp;
          } else if (target.isPtr(v2) || v2 === null || v2 === undefined) {
      ...
      cache.xWrap.convertResult = (t, v2) => t === null ? v2 : t ? __xResultAdapterCheck(t)(v2) : undefined;
      cache.xWrap.convertResultNoCheck = (t, v2) => t === null ? v2 : t ? xResult.get(t)(v2) : undefined;
      target.xWrap = function callee(fArg, resultType, ...argTypes) {
        ...
        if (xf.length === 0 && (resultType === null || resultType === "null")) {
          return xf;
        }
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      const { heap, alloc, dealloc } = config, realloc = config.realloc || function() {
      ...
      let ptr;
      const ptrSize = config.pointerSize || config.ptrSize || (typeof (ptr = alloc(1)) === "bigint" ? 8 : 4);
      const ptrIR = config.pointerIR || config.ptrIR || (ptrSize === 4 ? "i32" : "i64");
      if (ptr) {
        dealloc(ptr);
        ptr = undefined;
      }
      ...
      const __asPtrType = ptrIR == "i32" ? Number : __BigInt;
      const __NullPtr = __asPtrType(0);
      const __ptrAdd = function(...args) {
        let rc = __NullPtr;
      ...
      const isPtrSig = (s) => s === "p" || s === "P" || s === "s";
      const isAutoPtrSig = (s) => s === "P";
      ...
      const __isPtr32 = (ptr2) => typeof ptr2 === "number" && ptr2 === (ptr2 | 0) && ptr2 >= 0;
      const __isPtr64 = (ptr2) => typeof ptr2 === "bigint" && ptr2 >= 0 || __isPtr32(ptr2);
      const __isPtr = ptrSize === 4 ? __isPtr32 : __isPtr64;
      ...
      const __freeStruct = function(ctor, obj, m) {
        ...
        if (ctor.debugFlags.__flags.dealloc) {
          log("debug.dealloc:", ii.ownsPointer ? "" : "EXTERNAL", ctor.structName, "instance:", ctor.structInfo.sizeof, "bytes @" + m);
        }
        if (ii.ownsPointer) {
          if (ii.zod || ctor.structInfo.zeroOnDispose) {
            heap().fill(0, Number(m), Number(m) + ctor.structInfo.sizeof + ii.xb);
          }
          dealloc(m);
        }
      };
      ...
      const __allocStruct = function f(ctor, obj, xm) {
        ...
        try {
          ...
          if (ctor.debugFlags.__flags.alloc) {
            log("debug.alloc:", fill ? "" : "EXTERNAL", ctor.structName, "instance:", ctor.structInfo.sizeof, "bytes @" + xm);
          }
          if (fill) {
      ...
      const __adaptor = function(who, which, key, proxy2) {
      ...
      const __adaptStruct2 = function(who, key) {
        const si = typeof key === "string" ? __adaptor(who, 2, key) : key;
        if (typeof si !== "object") {
      ...
      const __lookupMember = function(structInfo, memberName, tossIfNotFound = true) {
        ...
        if (!m && (memberPrefix || memberSuffix)) {
          ...
          if (!m && tossIfNotFound) {
            toss(sPropName(structInfo.name || structInfo.structName, memberName), "is not a mapped struct member.");
          }
        }
        return m;
      };
      ...
      const __memberIsString = function(obj, memberName, tossIfNotFound = false) {
        ...
        return m && m.signature.length === 1 && m.signature[0] === "s" ? m : false;
      };
      ...
      const memberGetterProxy = function(si) {
        return si.get || (si.adaptGet ? StructBinder.adaptGet(si.adaptGet) : undefined);
      };
      const memberSetterProxy = function(si) {
        return si.set || (si.adaptSet ? StructBinder.adaptSet(si.adaptSet) : undefined);
      };
      const makeMemberStructWrapper = function callee(ctor, name, si) {
        const __innerStructs = callee.innerStructs ??= new Map;
        const key = ctor.memberKey(name);
        if (si.signature !== undefined) {
          toss("'signature' cannot be used on an embedded struct (", ctor.structName, ".", key, ").");
        }
        ...
        const prop = Object.assign(Object.create(null), {
          ...
          get: function() {
            const dbg2 = this.debugFlags.__flags;
            const p = this.pointer;
            const k2 = p + "." + key;
            ...
            if (getterProxy)
              s = getterProxy.apply(this, [s, key]);
            if (dbg2.getter)
              log("debug.getter: result =", s);
            return s;
          }
        });
      ...
      const makeMemberWrapper = function f(ctor, name, si) {
        ...
        const dbg2 = ctor.debugFlags.__flags;
        const getterProxy = memberGetterProxy(si);
        ...
        prop.get = function() {
          if (dbg2.getter) {
            log("debug.getter:", f.cache.getters[sigGlyph], "for", sigIR(sigGlyph), xPropName, "@", this.pointer, "+", si.offset, "sz", si.sizeof);
          }
          let rc = new DataView(heap().buffer, Number(this.pointer) + si.offset, si.sizeof)[f.cache.getters[sigGlyph]](0, isLittleEndian);
          if (getterProxy)
            rc = getterProxy.apply(this, [key, rc]);
          if (dbg2.getter)
        ...
        if (si.readOnly) {
          ...
          prop.set = function(v2) {
            if (dbg2.setter) {
              log("debug.setter:", f.cache.setters[sigGlyph], "for", sigIR(sigGlyph), xPropName, "@", this.pointer, "+", si.offset, "sz", si.sizeof, v2);
            }
            if (!this.pointer) {
              toss("Cannot set native property on a disposed", this.structName, "instance.");
            }
            if (setterProxy)
              v2 = setterProxy.apply(this, [key, v2]);
      ...
      const StructBinderImpl = function StructBinderImpl(structName, si, opt = Object.create(null)) {
        ...
        const self = this;
        const ads = (x) => {
          return typeof x === "string" && looksLikeASig(x) ? { signature: x } : __adaptStruct2(self, x);
        };
        ...
        if (si.adapt) {
          Object.keys(si.adapt.struct || {}).forEach((k2) => {
            __adaptStruct.call(StructBinderImpl, k2, si.adapt.struct[k2]);
          });
          Object.keys(si.adapt.set || {}).forEach((k2) => {
            __adaptSet.call(StructBinderImpl, k2, si.adapt.set[k2]);
          });
          Object.keys(si.adapt.get || {}).forEach((k2) => {
            __adaptGet.call(StructBinderImpl, k2, si.adapt.get[k2]);
          });
        }
        ...
        Object.keys(si.members || {}).forEach((k2) => {
          ...
          if (m.offset === undefined) {
            if (autoCalc)
              ...
              toss(sPropName(structName, k2), "is missing its offset.", JSON.stringify(m));
            }
          }
          si.members[k2] = m;
          ...
          if (autoCalc)
            m.autoCalcSizeOffset = true;
          makeMemberWrapper.call(self, StructCtor, k2, m);
          if (oldAutoCalc)
            m.autoCalcSizeOffset = true;
          else
            delete m.autoCalcSizeOffset;
          offset += m.sizeof;
        });
        if (!lastMember)
        ...
        if (!si.sizeof)
          si.sizeof = offset;
        if (si.sizeof === 1) {
          si.signature === "c" || si.signature === "C" || toss("Unexpected sizeof==1 member", sPropName(structName, k), "with signature", si.signature);
        } else {
          if (si.sizeof % 4 !== 0) {
      ...
      const StructBinder = function StructBinder(structName, structInfo) {
        return arguments.length == 1 ? StructBinderImpl.call(StructBinder, structName) : StructBinderImpl.call(StructBinder, structName, structInfo);
      };
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      if (!!wasm.exports.sqlite3_progress_handler) {
        bindingSignatures.core.push(["sqlite3_progress_handler", undefined, [
          "sqlite3*",
          "int",
          new wasm.xWrap.FuncPtrAdapter({
      ...
      if (!!wasm.exports.sqlite3_stmt_explain) {
        bindingSignatures.core.push(["sqlite3_stmt_explain", "int", "sqlite3_stmt*", "int"], ["sqlite3_stmt_isexplain", "int", "sqlite3_stmt*"]);
      }
      if (!!wasm.exports.sqlite3_set_authorizer) {
        bindingSignatures.core.push(["sqlite3_set_authorizer", "int", [
          "sqlite3*",
          new wasm.xWrap.FuncPtrAdapter({
      ...
      if (!!wasm.exports.sqlite3_column_origin_name) {
        bindingSignatures.core.push(["sqlite3_column_database_name", "string", "sqlite3_stmt*", "int"], ["sqlite3_column_origin_name", "string", "sqlite3_stmt*", "int"], ["sqlite3_column_table_name", "string", "sqlite3_stmt*", "int"]);
      }
      if (false) {}
      if (wasm.bigIntEnabled && !!wasm.exports.sqlite3_declare_vtab) {
        bindingSignatures.int64.push([
          ...
          "int",
          ["sqlite3*", "string", "sqlite3_module*", "*", "*"]
        ], ["sqlite3_declare_vtab", "int", ["sqlite3*", "string:flexible"]], ["sqlite3_drop_modules", "int", ["sqlite3*", "**"]], ["sqlite3_vtab_collation", "string", "sqlite3_index_info*", "int"], ["sqlite3_vtab_distinct", "int", "sqlite3_index_info*"], ["sqlite3_vtab_in", "int", "sqlite3_index_info*", "int", "int"], ["sqlite3_vtab_in_first", "int", "sqlite3_value*", "**"], ["sqlite3_vtab_in_next", "int", "sqlite3_value*", "**"], ["sqlite3_vtab_nochange", "int", "sqlite3_context*"], ["sqlite3_vtab_on_conflict", "int", "sqlite3*"], ["sqlite3_vtab_rhs_value", "int", "sqlite3_index_info*", "int", "**"]);
      }
      if (wasm.bigIntEnabled && !!wasm.exports.sqlite3_preupdate_hook) {
        bindingSignatures.int64.push(["sqlite3_preupdate_blobwrite", "int", "sqlite3*"], ["sqlite3_preupdate_count", "int", "sqlite3*"], ["sqlite3_preupdate_depth", "int", "sqlite3*"], ["sqlite3_preupdate_hook", "*", [
          "sqlite3*",
          new wasm.xWrap.FuncPtrAdapter({
          ...
          "*"
        ]], ["sqlite3_preupdate_new", "int", ["sqlite3*", "int", "**"]], ["sqlite3_preupdate_old", "int", ["sqlite3*", "int", "**"]]);
      }
      if (wasm.bigIntEnabled && !!wasm.exports.sqlite3changegroup_add && !!wasm.exports.sqlite3session_create && !!wasm.exports.sqlite3_preupdate_hook) {
        ...
        bindingSignatures.int64.push(["sqlite3changegroup_add", "int", ["sqlite3_changegroup*", "int", "void*"]], ["sqlite3changegroup_add_strm", "int", [
          "sqlite3_changegroup*",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xInput",
            signature: "i(ppp)",
          ...
          "void*"
        ]], ["sqlite3changegroup_delete", undefined, ["sqlite3_changegroup*"]], ["sqlite3changegroup_new", "int", ["**"]], ["sqlite3changegroup_output", "int", ["sqlite3_changegroup*", "int*", "**"]], ["sqlite3changegroup_output_strm", "int", [
          "sqlite3_changegroup*",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xOutput",
            signature: "i(ppi)",
          ...
          "int*",
          "int"
        ]], ["sqlite3changeset_concat", "int", ["int", "void*", "int", "void*", "int*", "**"]], ["sqlite3changeset_concat_strm", "int", [
          new wasm.xWrap.FuncPtrAdapter({
            name: "xInputA",
            signature: "i(ppp)",
            bindScope: "transient"
          ...
          "void*"
        ]], ["sqlite3changeset_conflict", "int", ["sqlite3_changeset_iter*", "int", "**"]], ["sqlite3changeset_finalize", "int", ["sqlite3_changeset_iter*"]], ["sqlite3changeset_fk_conflicts", "int", ["sqlite3_changeset_iter*", "int*"]], ["sqlite3changeset_invert", "int", ["int", "void*", "int*", "**"]], ["sqlite3changeset_invert_strm", "int", [
          new wasm.xWrap.FuncPtrAdapter({
            name: "xInput",
            signature: "i(ppp)",
            bindScope: "transient"
          ...
          "void*"
        ]], ["sqlite3changeset_new", "int", ["sqlite3_changeset_iter*", "int", "**"]], ["sqlite3changeset_next", "int", ["sqlite3_changeset_iter*"]], ["sqlite3changeset_old", "int", ["sqlite3_changeset_iter*", "int", "**"]], ["sqlite3changeset_op", "int", [
          "sqlite3_changeset_iter*",
          "**",
          "int*",
          "int*",
          "int*"
        ]], ["sqlite3changeset_pk", "int", ["sqlite3_changeset_iter*", "**", "int*"]], ["sqlite3changeset_start", "int", ["**", "int", "*"]], ["sqlite3changeset_start_strm", "int", [
          "**",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xInput",
            signature: "i(ppp)",
          ...
          "void*"
        ]], ["sqlite3changeset_start_v2", "int", ["**", "int", "*", "int"]], ["sqlite3changeset_start_v2_strm", "int", [
          "**",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xInput",
            signature: "i(ppp)",
          ...
          "void*",
          "int"
        ]], ["sqlite3session_attach", "int", ["sqlite3_session*", "string"]], ["sqlite3session_changeset", "int", ["sqlite3_session*", "int*", "**"]], ["sqlite3session_changeset_size", "i64", ["sqlite3_session*"]], ["sqlite3session_changeset_strm", "int", [
          "sqlite3_session*",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xOutput",
            signature: "i(ppp)",
          ...
          "void*"
        ]], ["sqlite3session_config", "int", ["int", "void*"]], ["sqlite3session_create", "int", ["sqlite3*", "string", "**"]], ["sqlite3session_diff", "int", ["sqlite3_session*", "string", "string", "**"]], ["sqlite3session_enable", "int", ["sqlite3_session*", "int"]], ["sqlite3session_indirect", "int", ["sqlite3_session*", "int"]], ["sqlite3session_isempty", "int", ["sqlite3_session*"]], ["sqlite3session_memory_used", "i64", ["sqlite3_session*"]], ["sqlite3session_object_config", "int", ["sqlite3_session*", "int", "void*"]], ["sqlite3session_patchset", "int", ["sqlite3_session*", "*", "**"]], ["sqlite3session_patchset_strm", "int", [
          "sqlite3_session*",
          new wasm.xWrap.FuncPtrAdapter({
            name: "xOutput",
            signature: "i(ppp)",
      ...
      delete globalThis.Jaccwabyt;
      {
        ...
        wasm.xWrap.argAdapter("sqlite3_filename", __xArgPtr)("sqlite3_context*", __xArgPtr)("sqlite3_value*", __xArgPtr)("void*", __xArgPtr)("sqlite3_changegroup*", __xArgPtr)("sqlite3_changeset_iter*", __xArgPtr)("sqlite3_session*", __xArgPtr)("sqlite3_stmt*", (v2) => __xArgPtr(v2 instanceof (sqlite3?.oo1?.Stmt || nilType) ? v2.pointer : v2))("sqlite3*", (v2) => __xArgPtr(v2 instanceof (sqlite3?.oo1?.DB || nilType) ? v2.pointer : v2))("sqlite3_vfs*", (v2) => {
          if (typeof v2 === "string") {
            return capi.sqlite3_vfs_find(v2) || sqlite3.SQLite3Error.toss(capi.SQLITE_NOTFOUND, "Unknown sqlite3_vfs name:", v2);
          }
          return __xArgPtr(v2 instanceof (capi.sqlite3_vfs || nilType) ? v2.pointer : v2);
        });
        if (wasm.exports.sqlite3_declare_vtab) {
          wasm.xWrap.argAdapter("sqlite3_index_info*", (v2) => __xArgPtr(v2 instanceof (capi.sqlite3_index_info || nilType) ? v2.pointer : v2))("sqlite3_module*", (v2) => __xArgPtr(v2 instanceof (capi.sqlite3_module || nilType) ? v2.pointer : v2));
        }
        ...
        for (const e of bindingSignatures.int64) {
          capi[e[0]] = wasm.bigIntEnabled ? wasm.xWrap.apply(null, e) : () => toss(e[0] + "() is unavailable due to lack", "of BigInt support in this build.");
        }
      ...
      const __dbArgcMismatch = (pDb2, f, n) => {
        return util.sqlite3__wasm_db_error(pDb2, capi.SQLITE_MISUSE, f + "() requires " + n + " argument" + (n === 1 ? "" : "s") + ".");
      };
      ...
      const __dbCleanupMap = function(pDb2, mode) {
        ...
        if (!mode) {
          ...
          this.dbMap.set(pDb2, m = Object.create(null));
        }
        return m;
      ...
      }
      {
        ...
        capi.sqlite3_create_collation_v2 = function(pDb2, zName, eTextRep, pArg, xCompare, xDestroy) {
          ...
          try {
            ...
            if (rc === 0 && xCompare instanceof Function) {
        ...
        capi.sqlite3_create_collation = (pDb2, zName, eTextRep, pArg, xCompare) => {
          return arguments.length === 5 ? capi.sqlite3_create_collation_v2(pDb2, zName, eTextRep, pArg, xCompare, 0) : __dbArgcMismatch(pDb2, "sqlite3_create_collation", 5);
        };
      }
      {
        ...
        capi.sqlite3_create_function_v2 = function f(pDb2, funcName, nArg, eTextRep, pApp, xFunc, xStep, xFinal, xDestroy) {
          ...
          try {
            ...
            if (rc === 0 && (xFunc instanceof Function || xStep instanceof Function || xFinal instanceof Function || xDestroy instanceof Function)) {
        ...
        if (__sqlite3CreateWindowFunction) {
          capi.sqlite3_create_window_function = function f(pDb2, funcName, nArg, eTextRep, pApp, xStep, xFinal, xValue, xInverse, xDestroy) {
            ...
            try {
              ...
              if (rc === 0 && (xStep instanceof Function || xFinal instanceof Function || xValue instanceof Function || xInverse instanceof Function || xDestroy instanceof Function)) {
      ...
      }
      {
        ...
        capi.sqlite3_bind_text = function f(pStmt, iCol, text, nText, xDestroy) {
          ...
          } else if (wasm.isPtr(text) || text === null) {
          ...
          try {
            if (util.isSQLableTypedArray(text)) {
              ...
              return util.sqlite3__wasm_db_error(capi.sqlite3_db_handle(pStmt), capi.SQLITE_MISUSE, "Invalid 3rd argument type for sqlite3_bind_text().");
            }
        ...
        capi.sqlite3_bind_blob = function f(pStmt, iCol, pMem2, nMem, xDestroy) {
          ...
          } else if (wasm.isPtr(pMem2) || pMem2 === null) {
          ...
          try {
            ...
            } else if (typeof pMem2 === "string") {
              [p, n] = wasm.allocCString(pMem2);
            } else {
              return util.sqlite3__wasm_db_error(capi.sqlite3_db_handle(pStmt), capi.SQLITE_MISUSE, "Invalid 3rd argument type for sqlite3_bind_blob().");
            }
      ...
      }
      {
        ...
        capi.sqlite3_auto_extension = function(fPtr) {
          ...
          } else if (arguments.length !== 1 || !wasm.isPtr(fPtr)) {
            return capi.SQLITE_MISUSE;
          }
        ...
        capi.sqlite3_cancel_auto_extension = function(fPtr) {
          if (!fPtr || arguments.length !== 1 || !wasm.isPtr(fPtr))
            return 0;
          ...
          callee.argcProxy = function(tgt2, funcName, func2, sig) {
            return function(...args) {
              if (func2.length !== arguments.length) {
                toss("Argument mismatch for", tgt2.structInfo.name + "::" + funcName + ": Native signature is:", sig);
              }
      ...
      StructBinder.StructType.prototype.installMethod = function callee(name, func, applyArgcCheck = installMethod.installMethodArgcCheck) {
        return arguments.length < 3 && name && typeof name === "object" ? installMethods(this, ...arguments) : installMethod(this, ...arguments);
      };
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      const debug = sqlite3.__isUnderTest ? outWrapper(console.debug.bind(console)) : outWrapper(sqlite3.config.debug);
      const warn = sqlite3.__isUnderTest ? outWrapper(console.warn.bind(console)) : outWrapper(sqlite3.config.warn);
      const error = sqlite3.__isUnderTest ? outWrapper(console.error.bind(console)) : outWrapper(sqlite3.config.error);
      ...
      const __dbTraceToConsole = wasm.installFunction("i(ippp)", function(t, c, p, x) {
        if (capi.SQLITE_TRACE_STMT === t) {
          console.log("SQL TRACE #" + ++this.counter, "via sqlite3@" + c + "[" + capi.sqlite3_db_filename(c, null) + "]", wasm.cstrToJs(x));
        }
      }.bind({ counter: 0 }));
      ...
      const dbCtorHelper = function ctor(...args) {
        ...
        if (pDb2 = opt["sqlite3*"]) {
          ...
          let { filename: fn, vfs: vfsName, flags: flagsStr } = opt;
          if (typeof fn !== "string" && !wasm.isPtr(fn) || typeof flagsStr !== "string" || vfsName && (typeof vfsName !== "string" && !wasm.isPtr(vfsName))) {
          ...
          try {
            ...
            if (flagsStr.indexOf("t") >= 0) {
              capi.sqlite3_trace_v2(pDb2, capi.SQLITE_TRACE_STMT, __dbTraceToConsole, pDb2);
            }
          } catch (e) {
            if (pDb2)
      ...
      const parseExecArgs = function(db, args) {
        ...
        out2.opt = Object.create(null);
        switch (args.length) {
          case 1:
            if (typeof args[0] === "string" || util.isSQLableTypedArray(args[0])) {
              out2.sql = args[0];
        ...
        if (opt.callback || opt.resultRows) {
          switch (opt.rowMode === undefined ? "array" : opt.rowMode) {
            case "object":
            ...
            default:
              if (util.isInt32(opt.rowMode)) {
                ...
                break;
              } else if (typeof opt.rowMode === "string" && opt.rowMode.length > 1 && opt.rowMode[0] === "$") {
                const $colName = opt.rowMode.substr(1);
                out2.cbArg = (stmt) => {
                  const rc = stmt.get(Object.create(null))[$colName];
                  return rc === undefined ? toss3(capi.SQLITE_NOTFOUND, "exec(): unknown result column:", $colName) : rc;
                };
                break;
              }
      ...
      DB.prototype = {
              ...
              if (evalFirstResult && stmt.columnCount) {
                ...
                if (arg.cbArg || resultRows) {
                  ...
                  for (;stmt.step(); __execLock.delete(stmt)) {
                    ...
                    if (resultRows)
                      resultRows.push(row);
                    if (callback && callback.call(opt, row, stmt) === false) {
                      break;
                    }
                  }
        ...
        createFunction: function f(name, xFunc, opt) {
          ...
          const pApp = opt.pApp;
          if (pApp !== undefined && pApp !== null && !wasm.isPtr(pApp)) {
          ...
          const arityArg = typeof arity === "number" ? arity : xArity.length ? xArity.length - 1 : 0;
          let rc;
          if (isWindow) {
      ...
      DB.wrapHandle = function(pDb2, takeOwnership = false) {
        if (!pDb2 || !wasm.isPtr(pDb2)) {
          throw new sqlite3.SQLite3Error(capi.SQLITE_MISUSE, "Argument must be a WASM sqlite3 pointer");
        }
        return new DB({
          "sqlite3*": pDb2,
      ...
      const isSupportedBindType = function(v2) {
        let t = BindTypes[v2 === null || v2 === undefined ? "null" : typeof v2];
        switch (t) {
          ...
          default:
            return util.isBindableTypedArray(v2) ? BindTypes.blob : undefined;
        }
      };
      ...
      const affirmParamIndex = function(stmt, key) {
        const n = typeof key === "number" ? key : capi.sqlite3_bind_parameter_index(stmt.pointer, key);
        if (n === 0 || !util.isInt32(n))
      ...
      const bindOne = function f(stmt, ndx, bindType, val) {
        ...
        let rc = 0;
        switch (val === null || val === undefined ? BindTypes.null : bindType) {
          case BindTypes.null:
      ...
      Stmt.prototype = {
        ...
        bind: function() {
          ...
          if (typeof arg === "object" && !util.isBindableTypedArray(arg)) {
            if (arguments.length !== 1) {
        ...
        get: function(ndx, asType) {
          ...
          switch (asType === undefined ? capi.sqlite3_column_type(this.pointer, ndx) : asType) {
            case capi.SQLITE_NULL:
              return null;
            case capi.SQLITE_INTEGER: {
              if (wasm.bigIntEnabled) {
        ...
        getParamName: function(ndx) {
          return affirmStmtOpen(this).parameterCount ? capi.sqlite3_bind_parameter_name(this.pointer, ndx) : undefined;
        },
        isBusy: function() {
          return capi.sqlite3_stmt_busy(affirmStmtOpen(this)) !== 0;
        },
        isReadOnly: function() {
          return capi.sqlite3_stmt_readonly(affirmStmtOpen(this)) !== 0;
        }
      };
      {
        const prop = {
      ...
      Stmt.wrapHandle = function(oo1db, pStmt, takeOwnership = false) {
        ...
        if (!(oo1db instanceof DB) || !oo1db.pointer) {
          throw new sqlite3.SQLite3Error(sqlite3.SQLITE_MISUSE, "First argument must be an opened " + "sqlite3.oo1.DB instance");
        }
        if (!pStmt || !wasm.isPtr(pStmt)) {
          throw new sqlite3.SQLite3Error(sqlite3.SQLITE_MISUSE, "Second argument must be a WASM " + "sqlite3_stmt pointer");
        }
      ...
      sqlite3.initWorker1API = function() {
        ...
        const wState = {
          ...
          getDb: function(id, require2 = true) {
            return this.dbs[id] || (require2 ? toss("Unknown (or closed) DB ID:", id) : undefined);
          }
        };
        ...
        const wMsgHandler = {
          ...
          close: function(ev) {
            ...
            if (db) {
              const doUnlink = ev.args && typeof ev.args === "object" ? !!ev.args.unlink : false;
              wState.close(db, doUnlink);
            }
            return response;
          },
          exec: function(ev) {
            const rc = typeof ev.args === "string" ? { sql: ev.args } : ev.args || Object.create(null);
            if (rc.rowMode === "stmt") {
            ...
            try {
              const changeCount = rc.countChanges ? db.changes(true, rc.countChanges === 64) : undefined;
              db.exec(rc);
              if (changeCount !== undefined) {
                rc.changeCount = db.changes(true, rc.countChanges === 64) - changeCount;
              }
              const lastInsertRowId = rc.lastInsertRowId ? sqlite32.capi.sqlite3_last_insert_rowid(db) : undefined;
          ...
          "config-get": function() {
            const rc = Object.create(null), src = sqlite32.config;
            [
              "bigIntEnabled"
            ].forEach(function(k2) {
        ...
        globalThis.onmessage = async function(ev) {
          ...
          try {
            ...
            if (err2.stack) {
              result.stack = typeof err2.stack === "string" ? err2.stack.split(/\n\s*/) : err2.stack;
            }
            if (0)
              ;
          }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      const { wasm, capi } = sqlite3, toss = sqlite3.util.toss3;
      ...
      vfs.installVfs = function(opt) {
        ...
        for (const key of propList) {
          ...
          if (o) {
            ...
            if (key === "vfs") {
              if (!o.struct.$zName && typeof o.name === "string") {
      ...
      vtab.setupModule = function(opt) {
        ...
        try {
          ...
          for (const e of Object.entries({
            ...
            const k2 = e[0], v2 = e[1];
            if (methods[k2] === true)
              methods[k2] = methods[v2];
            else if (methods[v2] === true)
              methods[v2] = methods[k2];
          }
          if (opt.catchExceptions) {
            ...
            for (const k2 of mnames) {
              ...
              if (!(m instanceof Function))
                continue;
              else if (k2 === "xConnect" && methods.xCreate === m) {
                remethods[k2] = methods.xCreate;
              } else if (k2 === "xCreate" && methods.xConnect === m) {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      if (!pKvvfs)
        return;
      if (0) {}
      const { util, wasm } = sqlite3, toss3 = util.toss3, hop = (o, k2) => Object.prototype.hasOwnProperty.call(o, k2);
      ...
      class KVVfsStorage {
        ...
        key(n) {
          const k2 = this.#getKeys();
          return n < k2.length ? k2[n] : null;
        }
        getItem(k2) {
      ...
      const validateStorageName = function(n, mayBeJournal = false) {
        ...
        if (cache.rxJournalSuffix.test(n)) {
          ...
          toss3(capi.SQLITE_MISUSE, "Storage names may not have a -wal or -shm suffix.");
        } else {
          maxLen -= 8;
        }
        if (len > maxLen) {
        ...
        for (i = 0;i < len; ++i) {
          ...
          if (ch < 32) {
            toss3(capi.SQLITE_RANGE, "Illegal character (" + ch + "d) in storage name:", n);
          }
        }
      };
        ...
        try {
          ...
          for (const ear of store.listeners) {
            ...
            if (f) {
              ...
              if (eventName === "write" && ear.decodePages && +args[0] > 0) {
                ev.data = [args[0]];
                if (wcache?.[args[0]]) {
                ...
                ev.data = args.length ? args.length === 1 ? args[0] : args : undefined;
              }
              try {
      ...
      const storageForZClass = (zClass) => typeof zClass === "string" ? cache.storagePool[zClass] : cache.storagePool[wasm.cstrToJs(zClass)];
      ...
      const methodOverrides = {
        recordHandler: {
          xRcrdRead: (zClass, zKey, zBuf, nBuf) => {
            try {
              ...
              if (nBuf + 1 < nV) {
                toss3(capi.SQLITE_RANGE, "xRcrdRead()", jzClass, jXKey, "input buffer is too small: need", nV, "but have", nBuf);
              }
              if (0) {}
        ...
        vfs: {
          xOpen: function(pProtoVfs, zName, pProtoFile, flags, pOutFlags) {
            ...
            try {
              ...
              if (flags & (capi.SQLITE_OPEN_MAIN_DB | capi.SQLITE_OPEN_TEMP_DB | capi.SQLITE_OPEN_TRANSIENT_DB) && cache.rxJournalSuffix.test(jzClass)) {
                toss3(capi.SQLITE_ERROR, "DB files may not have a '-journal' suffix.");
              }
          ...
          xAccess: function(pProtoVfs, zPath, flags, pResOut) {
            ...
            try {
              ...
              if (kvvfs?.log?.xAccess) {
                debug("xAccess", jzPath, "flags =", flags, "*pResOut =", wasm.peek32(pResOut), "store =", s);
              }
              if (!s) {
                try {
          ...
          xRandomness: function(pVfs2, nOut, pOut) {
            ...
            for (;i < nOut; ++i)
              heap[npOut + i] = Math.random() * 255000 & 255;
            return nOut;
          },
          ...
          xFileControl: function(pFile, opId, pArg) {
            ...
            try {
              ...
              if (opId === capi.SQLITE_FCNTL_PRAGMA && kvvfs.internal.disablePageSizeChange) {
                ...
                if (wasm.cstrToJs(zName) === "page_size") {
              ...
              if (rc == 0 && capi.SQLITE_FCNTL_SYNC === opId) {
      ...
      const sqlite3_js_kvvfs_clear = function callee(which) {
        ...
        if (store.files.length) {
          if (globalThis.localStorage === store.storage || globalThis.sessionStorage === store.storage) {} else {
            toss3(capi.SQLITE_ACCESS, "Cannot clear in-use database storage.");
          }
        }
      ...
      const sqlite3_js_kvvfs_export = function callee(...args) {
        ...
        if (!store) {
          toss3(capi.SQLITE_NOTFOUND, "There is no kvvfs storage named", opt?.name);
        }
        const s = store.storage;
        ...
        const rxTail = keyPrefix ? /^kvvfs-[^-]+-(\w+)/ : undefined;
        let i = 0, n = s.length;
        for (;i < n; ++i) {
          const k2 = s.key(i);
          if (!keyPrefix || k2.startsWith(keyPrefix)) {
            let kk = (keyPrefix ? rxTail.exec(k2) : undefined)?.[1] ?? k2;
            switch (kk) {
              case "jrnl":
                if (opt.includeJournal)
                  rc.journal = s.getItem(k2);
                break;
              case "sz":
      ...
      const sqlite3_js_kvvfs_import = function(exp, overwrite = false) {
        if (!exp?.timestamp || !exp.name || exp.size === undefined || !Array.isArray(exp.pages)) {
        ...
        if (store) {
          if (!overwrite) {
            toss3(capi.SQLITE_ACCESS, "Storage '" + exp.name + "' already exists and", "overwrite was not specified.");
          } else if (!store.files || !store.jzClass) {
            toss3(capi.SQLITE_ERROR, "Internal storage object", exp.name, "seems to be malformed.");
          } else if (store.files.length) {
            toss3(capi.SQLITE_IOERR_ACCESS, "Cannot import db storage while it is in use.");
          }
        ...
        try {
          ...
          if (exp.journal)
            s.setItem(keyPrefix + "jrnl", exp.journal);
          if (exp.pages[0] instanceof Uint8Array) {
            exp.pages.forEach((u, ndx) => {
              ...
              util.assert(wasm.peek8(wasm.ptr.add(zEnc, rc)) === 0, "Expecting NUL-terminated encoded output");
          ...
          if (isNew)
            installStorageAndJournal(store);
        } catch {
          if (!isNew) {
            try {
              sqlite3_js_kvvfs_clear(exp.name);
      ...
      const sqlite3_js_kvvfs_unlink = function(name) {
        ...
        if (!store || kvvfsIsPersistentName(store.jzClass) || isBuiltinName(store.jzClass) || cache.rxJournalSuffix.test(name))
          return false;
        if (store.refc > store.files.length || store.files.length === 0) {
          if (--store.refc <= 0) {
            deleteStorage(store);
          }
          return true;
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      const installOpfsVfs = function callee(options) {
        ...
        if (options.sanityChecks === undefined) {
          options.sanityChecks = urlParams.has("opfs-sanity-check");
        }
        if (options.proxyUri === undefined) {
          options.proxyUri = callee.defaultProxyUri;
        }
        if (typeof options.proxyUri === "function") {
...
Total of`, n, "op(s) for", t, "ms (incl. " + w + " ms of waiting on the async side)");
            ...
            reset: function() {
              ...
              for (k2 in state.opIds) {
                r(metrics[k2] = Object.create(null));
              }
          ...
          setTimeout(() => {
            if (promiseWasRejected === undefined) {
          ...
          [
            ...
            if ((state.sq3Codes[k2] = capi[k2]) === undefined) {
          ...
          const opRun = (op, ...args) => {
            ...
            while (Atomics.wait(state.sabOPView, state.opIds.rc, -1) !== "not-equal") {}
          ...
          const ioSyncWrappers = {
            ...
            xRead: function(pFile, pDest, n, offset64) {
              ...
              try {
                ...
                if (rc === 0 || capi.SQLITE_IOERR_SHORT_READ === rc) {
          ...
          const importDbChunked = async function(filename, callback) {
            ...
            try {
              sah.truncate(0);
              while ((chunk = await callback()) !== undefined) {
                if (chunk instanceof ArrayBuffer)
                  chunk = new Uint8Array(chunk);
                if (!checkedHeader && nWrote === 0 && chunk.byteLength >= 15) {
          ...
          if (sqlite3.oo1) {
            ...
            sqlite3.oo1.DB.dbCtorHelper.setVfsPostOpenCallback(opfsVfs.pointer, function(oo1Db, sqlite32) {
      ...
      globalThis.sqlite3ApiBootstrap.initializersAsync.push(async (sqlite32) => {
        try {
          ...
          return installOpfsVfs().catch((e) => {
            sqlite32.config.warn("Ignoring inability to install OPFS sqlite3_vfs:", e.message);
          });
        } catch (e) {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function(sqlite3) {
      ...
      const ioMethods = {
        ...
        xWrite: function(pFile, pSrc, n, offset64) {
          ...
          try {
            const nBytes = file.sah.write(wasm.heap8u().subarray(Number(pSrc), Number(pSrc) + n), { at: HEADER_OFFSET_DATA + Number(offset64) });
      ...
      class OpfsSAHPool {
        ...
        getFileNames() {
          const rc = [];
          for (const n of this.#mapFilenameToSAH.keys())
            rc.push(n);
          return rc;
        }
        async addCapacity(n) {
        ...
        getAssociatedPath(sah) {
          ...
          if (fileDigest.every((v2, i) => v2 === compDigest[i])) {
            const pathBytes = this.#apBody.findIndex((v2) => v2 === 0);
            if (pathBytes === 0) {
        ...
        pauseVfs() {
          if (this.#mapS3FileToOFile_.size > 0) {
            sqlite3.SQLite3Error.toss(capi.SQLITE_MISUSE, "Cannot pause VFS", this.vfsName, "because it has opened files.");
          }
        ...
        isPaused() {
          return this.#mapSAHToName.size === 0;
        }
        async unpauseVfs() {
          if (this.#mapSAHToName.size === 0) {
    ...
    try {
      const bootstrapConfig = Object.assign(Object.create(null), {
        memory: typeof wasmMemory !== "undefined" ? wasmMemory : EmscriptenModule["wasmMemory"],
        exports: typeof wasmExports !== "undefined" ? wasmExports : Object.prototype.hasOwnProperty.call(EmscriptenModule, "wasmExports") ? EmscriptenModule["wasmExports"] : EmscriptenModule["asm"]
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/sqlite-wasm/jswasm/sqlite3-worker1-promiser.mjs
globalThis.sqlite3Worker1Promiser = function callee(config = callee.defaultConfig) {
  ...
  config.worker.onmessage = function(ev) {
    ...
    if (!msgHandler) {
      if (ev && ev.type === "sqlite3-api" && ev.result === "worker1-ready") {
        if (config.onready)
  ...
  return promiserFunc = function() {
    ...
    const proxy2 = Object.create(null);
    proxy2.message = msg;
    let rowCallbackId;
    if (msg.type === "exec" && msg.args) {
      if (typeof msg.args.callback === "function") {
        rowCallbackId = msg.messageId + ":row";
        proxy2.onrow = msg.args.callback;
        msg.args.callback = rowCallbackId;
        handlerMap[rowCallbackId] = proxy2;
      } else if (typeof msg.args.callback === "string") {
...
globalThis.sqlite3Worker1Promiser.v2 = function callee2(config = callee2.defaultConfig) {
  ...
  if (typeof config == "function") {
    oldFunc = config;
    config = {};
  } else if (typeof config?.onready === "function") {
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/index.mjs
var sqlite3Worker1Promiser2 = globalThis.sqlite3Worker1Promiser;
var sqlite_wasm_default = sqlite3_default;

// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/dist/client/api.js
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/dist/client/uri.js
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/dist/client/util.js
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/dist/client/config.js
...
// node_modules/.bun/@sqlite.org+sqlite-wasm@github+ShaulLavo+sqlite-wasm+9e838ee/node_modules/@sqlite.org/sqlite-wasm/dist/client/index.js
...
var _Sqlite3Client_instances;
var _Sqlite3Client_sqlite3;
var _Sqlite3Client_path;
var _Sqlite3Client_db;
var _Sqlite3Client_intMode;
var _Sqlite3Client_poolUtil;
var _Sqlite3Client_checkNotClosed;
var _Sqlite3Client_getDb;
var _Sqlite3Transaction_instances;
var _Sqlite3Transaction_sqlite3;
var _Sqlite3Transaction_database;
var _Sqlite3Transaction_intMode;
var _Sqlite3Transaction_checkNotClosed;
function createClient(config, sqlite3) {
...
function _createClient(config, sqlite3) {
...
class Sqlite3Client {
  constructor(sqlite3, path, db, intMode, poolUtil) {
    _Sqlite3Client_instances.add(this);
    _Sqlite3Client_sqlite3.set(this, undefined);
    _Sqlite3Client_path.set(this, undefined);
    _Sqlite3Client_db.set(this, undefined);
    _Sqlite3Client_intMode.set(this, undefined);
    _Sqlite3Client_poolUtil.set(this, undefined);
  ...
  async transaction(mode = "write") {
    const db = __classPrivateFieldGet(this, _Sqlite3Client_instances, "m", _Sqlite3Client_getDb).call(this);
    executeStmt(__classPrivateFieldGet(this, _Sqlite3Client_sqlite3, "f"), db, transactionModeToBegin(mode), __classPrivateFieldGet(this, _Sqlite3Client_intMode, "f"));
    __classPrivateFieldSet(this, _Sqlite3Client_db, null, "f");
...
_Sqlite3Client_sqlite3 = new WeakMap, _Sqlite3Client_path = new WeakMap, _Sqlite3Client_db = new WeakMap, _Sqlite3Client_intMode = new WeakMap, _Sqlite3Client_poolUtil = new WeakMap, _Sqlite3Client_instances = new WeakSet, _Sqlite3Client_checkNotClosed = function _Sqlite3Client_checkNotClosed2() {
  if (this.closed) {
    throw new LibsqlError("The client is closed", "CLIENT_CLOSED");
  }
}, _Sqlite3Client_getDb = function _Sqlite3Client_getDb2() {
  if (__classPrivateFieldGet(this, _Sqlite3Client_db, "f") === null) {
...
class Sqlite3Transaction {
  constructor(sqlite3, database, intMode) {
    ...
    _Sqlite3Transaction_sqlite3.set(this, undefined);
    _Sqlite3Transaction_database.set(this, undefined);
    _Sqlite3Transaction_intMode.set(this, undefined);
...
_Sqlite3Transaction_sqlite3 = new WeakMap, _Sqlite3Transaction_database = new WeakMap, _Sqlite3Transaction_intMode = new WeakMap, _Sqlite3Transaction_instances = new WeakSet, _Sqlite3Transaction_checkNotClosed = function _Sqlite3Transaction_checkNotClosed2() {
  if (this.closed) {
...
// apps/web/src/workers/sqlite.ts
var log = console.log;
var sqlite3 = null;
var client = null;
var db = null;
...
var init = async () => {
  ...
  client = result[0];
  db = result[1];
  log(`[SQLite] v${sqlite3.version.libVersion} initialized. OPFS: ${opfsEnabled}, URL: ${client.config.url}`);
  return { version: sqlite3.version.libVersion, opfsEnabled };
};
var exec = async (sql) => {
  await getClient().execute(sql);
};
var run = async (sql, params) => {
...
var runDemo = async () => {
  ...
  const tablesResult = await c.execute("SELECT name FROM sqlite_master WHERE type='table' ORDER BY name");
  const tables = tablesResult.rows.map((row) => row[0]);
  log("[SQLite Demo] Tables:", tables);
  log("[SQLite Demo] Users:", users);
  return { tables, users };
};
var runFtsDemo = async (searchQuery) => {
  const c = getClient();
  await c.execute(`
  ...
  if (count === 0) {
    const docs = [
      {
        ...
        content: "SQLite is a C library that provides a lightweight disk-based database. It allows accessing the database using SQL queries without a separate server process."
      },
      {
        title: "Full-Text Search with FTS5",
        content: "FTS5 is an SQLite virtual table module that provides full-text search functionality. It supports advanced features like phrase queries and boolean operators."
      },
      {
        title: "WebAssembly and Databases",
        content: "Running SQLite in WebAssembly allows browsers to have a local database. This enables offline-first applications with powerful querying capabilities."
      },
      {
        title: "OPFS Storage in Browsers",
        content: "The Origin Private File System (OPFS) provides high-performance file access for web applications, perfect for persisting SQLite databases."
      },
      {
        title: "JavaScript and SQL Integration",
        content: "Modern web applications can use SQL for local data management. Libraries like sql.js and sqlite-wasm bring the power of SQL to the browser."
      }
    ];
    for (const doc of docs) {
      ...
      const lastId = lastIdResult.rows[0]?.[0];
      await c.execute({
  ...
  const documentsResult = await c.execute("SELECT id, title, content, 0 as rank FROM documents ORDER BY id");
  ...
  const searchResults = searchResult.rows.map((row) => ({
    id: row[0],
    title: row[1],
    content: row[2],
    rank: row[3]
